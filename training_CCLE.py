...
from models.gat_gcn_SA_LSTM_GSA_transformer_ge_mut_cross_CCLE import \
    GAT_GCN_SA_LSTM_GSA_Transformer_ge_mut_cross_CCLE
...
def main(modeling, train_batch, val_batch, test_batch, lr, num_epoch, log_interval, cuda_name):
    ...
    path = './result_SA_GCA_GCN_SA2GSA_cross_CCLE/'
...
if __name__ == "__main__":
    ...
    modeling = [GAT_GCN_SA_LSTM_GSA_Transformer_ge_mut_cross_CCLE][args.model]
    model = [modeling]
