...
class GAT_GCN_SA_LSTM_GSA_Transformer_ge_mut_cross(torch.nn.Module):
    def __init__(self, n_output=1, num_features_xd=78, num_features_xt=25,
                 n_filters=32, embed_dim=128, output_dim=128, dropout=0.2):

        super(GAT_GCN_SA_LSTM_GSA_Transformer_ge_mut_cross, self).__init__()
        ...
        self.fc1_xt_mut = nn.Linear(2944, 128)#1024
        ...
        self.fc1_xt_ge = nn.Linear(83584, output_dim)#3584
